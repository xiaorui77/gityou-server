...
public class ServletUtils {
     ...
     * @throws IllegalStateException the repository was not set by the filter, the servlet is
     ...
     * {@code x-gzip}.
     *
     * @param req the incoming request whose input stream needs to be opened.
     ...
     *
     * @param in the stream to discard, closed if not null.
     */
     ...
     *
     * @param content to return to the user agent as this entity's body.
     * @param req     the incoming request.
     * @param rsp     the outgoing response.
     * @throws IOException the servlet API rejected sending the body.
     */
    ...
    public static String identify(Repository git) {
